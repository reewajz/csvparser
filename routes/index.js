...
/* GET home page. */
router.get('/rest/v1/customer/:page?', function (req, res, next) {
...
router.get('/rest/v1/customer/delete/:delete?', function (req, res, next) {
  var p= req.params.page || 1;
...
router.post('/rest/v1/customer/search', function (req, res, next) {
